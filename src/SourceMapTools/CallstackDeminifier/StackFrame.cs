...
/// <summary>Represents a single entry in a JavaScript stack frame.</summary>
/// <remarks>Creates new instance stack frame with specified method name and source position.</remarks>
...
{
	/// <summary>Creates new instance stack frame with specified method name.</summary>
	/// <param name="methodName">Name of method, corresponding to current stack frame.</param>
	public StackFrame(string? methodName)
		: this(methodName, filePath: null, SourcePosition.NotFound)
	{
	}
	...
	/// <summary>The path of the file where this code is defined.</summary>
	public string? FilePath { get; set; } = filePath;

	/// <summary>The zero-based position of this stack entry.</summary>
	public SourcePosition SourcePosition { get; internal set; } = sourcePosition;

	/// <summary>Returns text representation of current stack frame.</summary>
