...
/// <summary>Identifies the location of a piece of code in a JavaScript file.</summary>
/// <remarks>Creates position instance with specified coordinates.</remarks>
...
public readonly struct SourcePosition(int line, int column) : IComparable<SourcePosition>, IEquatable<SourcePosition>
{
	...
	/// <summary>Zero-based position line number.</summary>
	public int Line { get; } = line;
	/// <summary>Zero-based position column number.</summary>
	public int Column { get; } = column;

	/// <summary>Compares current position instance with another position.</summary>
	...
	/// <summary>Checks if left position is going before right position.</summary>
	/// <param name="x">left position.</param>
	/// <param name="y">right position.</param>
	/// <returns>
	/// <list type="bullet">
	/// <item><see langword="true"/>: left position goes before right position;</item>
	/// <item><see langword="false"/>: left position is same or goes after right position.</item>
	/// </list>
	/// </returns>
	public static bool operator <(SourcePosition x, SourcePosition y) => x.CompareTo(y) < 0;

	/// <summary>Checks if left position is going after right position.</summary>
	/// <param name="x">left position.</param>
	/// <param name="y">right position.</param>
	/// <returns>
	/// <list type="bullet">
	/// <item><see langword="true"/>: left position goes after right position;</item>
	/// <item><see langword="false"/>: left position is same or goes before right position.</item>
	/// </list>
	/// </returns>
	public static bool operator >(SourcePosition x, SourcePosition y) => x.CompareTo(y) > 0;

	/// <summary>Checks if both positions are the same.</summary>
	/// <param name="x">left position.</param>
	/// <param name="y">right position.</param>
	/// <returns>
	/// <list type="bullet">
	/// <item><see langword="true"/>: both positions are the same;</item>
	/// <item><see langword="false"/>: positions differ from each other.</item>
	/// </list>
	/// </returns>
	public static bool operator ==(SourcePosition x, SourcePosition y) => x.Equals(y);

	/// <summary>Checks if both positions are not the same.</summary>
	/// <param name="x">left position.</param>
	/// <param name="y">right position.</param>
	/// <returns>
	/// <list type="bullet">
	/// <item><see langword="true"/>: both positions are not the the same;</item>
	/// <item><see langword="false"/>: positions are the same.</item>
	/// </list>
	/// </returns>
	public static bool operator !=(SourcePosition x, SourcePosition y) => !x.Equals(y);

	/// <summary>Compares current position with other one.</summary>
	...
	/// <list type="bullet">
	/// <item><see langword="true"/>: both positions are the same;</item>
	/// <item><see langword="false"/>: positions differ from each other oth <paramref name="obj"/> is not an instance of <see cref="SourcePosition"/>.</item>
	/// </list>
	/// </returns>
	...
	/// <summary>Returns true if we think that the two source positions are close enough together that they may in fact be the referring to the same piece of code.</summary>
	public bool IsEqualish(SourcePosition other)
	{
		...
		if (Math.Abs(Line - other.Line) is 1)
		{
			var largerLineNumber = Line > other.Line ? this : other;

			if (largerLineNumber.Column is 0)
			{
				return true;
			}
		}
	...
	/// <summary>Checks if left position is same or going before right position.</summary>
	/// <param name="left">left position.</param>
	/// <param name="right">right position.</param>
	/// <returns>
	/// <list type="bullet">
	/// <item><see langword="true"/>: left position is same or goes before right position;</item>
	/// <item><see langword="false"/>: left position is same or goes after right position.</item>
	/// </list>
	/// </returns>
	public static bool operator <=(SourcePosition left, SourcePosition right) => left.CompareTo(right) <= 0;

	/// <summary>Checks if left position is same or going after right position.</summary>
	/// <param name="left">left position.</param>
	/// <param name="right">right position.</param>
	/// <returns>
	/// <list type="bullet">
	/// <item><see langword="true"/>: left position is same or goes after right position;</item>
	/// <item><see langword="false"/>: left position goes before right position.</item>
	/// </list>
	/// </returns>
	public static bool operator >=(SourcePosition left, SourcePosition right) => left.CompareTo(right) >= 0;
}
