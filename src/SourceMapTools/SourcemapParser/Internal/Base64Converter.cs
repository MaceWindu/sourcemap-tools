...
/// <summary>Used to convert Base64 characters values into integers.</summary>
public static class Base64Converter
{
	...
	/// <summary>Converts a base64 value to an integer.</summary>
	...
	/// <summary>Converts a integer to base64 value.</summary>
